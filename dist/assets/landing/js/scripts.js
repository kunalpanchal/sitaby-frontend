...
jQuery(document).ready(function($) {
	...
	*****************************************************************************************/
	function loginButtonPress() {
	    alert('in');
	    $('#records_table').html("");
	    var emailId = document.getElementById('si_email').value;
	    var password = document.getElementById('si-password').value;

	    var JsonDataToBePassed = {
	        "eMail": emailId,
	        "password": password,
	        "isFBLogin": false,
	        "isGPlusLogin": false,
	    ...
	    $.ajax({
	        type: "POST",
	        data: JsonDataToBePassed,
	        dataType: 'json',
	        url: "http://www.sitaby.appbfit.com/api/Services/LoginAttempt",
	        beforeSend: function () {
	            $('#image').show();
	        },
	        complete: function () {
	        ...
	        success: function (data) {
	            ...
	            for (var key in data) {
	                var value = data[key];
	                if (i == 0) {
	                    trHTML += '<tr><td> success : ' + value + '</td>';
	                }
	                if (i == 1) {
	                    trHTML += '<td> isEmailVerified : ' + value + '</td>';
	                }
	                if (i == 2) {
	                    trHTML += '<td> ErrMessage : ' + value + '</td>';
	                }
	                if (i == 3) {
	                    trHTML += '<td>nickName : ' + value + '</td>';
	                }
	                if (i == 4) {
	                    trHTML += '<td> fullName : ' + value + '</td>';
	                }
	                if (i == 5) {
	                    trHTML += '<td> userId : ' + value + '</td></tr>';
	                }
	                i++;
	            }
